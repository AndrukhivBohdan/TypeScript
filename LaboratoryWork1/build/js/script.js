...
function validateName(name, name2) {
    if (![
        "leg",
        "hypotenuse",
        "adjacent angle",
...
function validateValue(value, name, value2, name2) {
...
function triangle(v1, n1, v2, n2) {
    if (!validateName(n1, n2) ||
    ...
    switch (pair) {
        ...
        case "adjacent angle|leg":
            showData(n1 === "leg" ? fromLegAdjacent(v1, v2) : fromLegAdjacent(v2, v1));
            break;
        case "leg|opposite angle":
            showData(n1 === "leg" ? fromLegOpposite(v1, v2) : fromLegOpposite(v2, v1));
            break;
        case "angle|hypotenuse":
            showData(n1 === "hypotenuse" ? fromHypAndAngle(v1, v2) : fromHypAndAngle(v2, v1));
            break;
        default:
